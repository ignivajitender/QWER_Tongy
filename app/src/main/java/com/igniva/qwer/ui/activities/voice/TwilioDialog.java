...
//                                                   TwilioVoiceClientActivity.ClientProfile clientProfile, Context context){
...
//        View dialogView = li.inflate(R.layout.twilio_dialog_registration, null);
//
...
//
//        LayoutInflater li = LayoutInflater.from(context);
//        View dialogView = li.inflate(R.layout.twilio_dialog_call, null);
