...
public class ImageBehavior extends CoordinatorLayout.Behavior<SimpleDraweeView> {
    ...
    public ImageBehavior(Context context, AttributeSet attrs) {
        ...
        mFinalLeftAvatarPadding = context.getResources().getDimension(R.dimen.image_width);
    }
...
//        float heightToSubtract = ((mStartHeight - finalHeight) * MIN_AVATAR_PERCENTAGE_SIZE);

        child.setY(mStartYPosition - distanceYToSubtract);
        child.setX(mStartXPosition - distanceXToSubtract);
//        child.setX(mStartXPosition - distanceXToSubtract+ Utility.convertPixelsToDp(225,mContext));
...
//        lp.height = (int) (mStartHeight );
    ...
    private void maybeInitProperties(SimpleDraweeView child, View dependency) {
        ...
        if (mFinalXPosition == 0)
            mFinalXPosition = (int) (mContext.getResources().getDimensionPixelOffset(R.dimen.abc_action_bar_content_inset_material) + (finalHeight / 2)+mContext.getResources().getDimensionPixelOffset(R.dimen._40dp));
