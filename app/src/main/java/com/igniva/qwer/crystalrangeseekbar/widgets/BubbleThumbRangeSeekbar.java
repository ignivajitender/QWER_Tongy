...
public class BubbleThumbRangeSeekbar extends CrystalRangeSeekbar {
    ...
    @Override
    public void drawLeftThumbWithColor(Canvas canvas, Paint paint, RectF rect) {
    ...
    @Override
    public void drawRightThumbWithColor(Canvas canvas, Paint paint, RectF rect) {
    ...
    @Override
    public void drawLeftThumbWithImage(Canvas canvas, Paint paint, RectF rect, Bitmap image) {
        if(isPressedLeftThumb){
    ...
    @Override
    public void drawRightThumbWithImage(Canvas canvas, Paint paint, RectF rect, Bitmap image) {
        if(isPressedRightThumb){
    ...
    public void startAnimationUp(final Thumb thumb){
    ...
    public void startAnimationDown(Thumb thumb){
