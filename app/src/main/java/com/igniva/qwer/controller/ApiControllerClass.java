...
//                changePasswordHashMap.put("post_id", post_id + "");
    ...
    public static void changeIsVoiceCall(Retrofit retrofit,final SettingsActivity activity, int isVoiceCall, SwitchCompat mswitchVideoCall) {
    ...
    public static void getOtherUserProfile(Retrofit retrofit, final OtherUserProfileActivity activity, int userId) {
