...
import com.igniva.qwer.utils.crystalrangeseekbar.interfaces.OnRangeSeekbarFinalValueListener;
...
public class CrystalRangeSeekbar extends View {
    ...
    public int getBarHighlightColor(final TypedArray typedArray){
        return typedArray.getColor(R.styleable.CrystalRangeSeekbar_bar_highlight_color, Color.BLACK);
    }

    public int getLeftThumbColor(final TypedArray typedArray){
    ...
    public void drawBar(final Canvas canvas, final Paint paint, final RectF rect){
    ...
    public void drawHighlightBar(final Canvas canvas, final Paint paint, final RectF rect){
        canvas.drawRoundRect(rect, cornerRadius, cornerRadius, paint);
    }
    ...
    public void drawLeftThumbWithColor(final Canvas canvas, final Paint paint, final RectF rect){
        canvas.drawOval(rect, paint);
    }

    public void drawLeftThumbWithImage(final Canvas canvas, final Paint paint, final RectF rect, final Bitmap image){
    ...
    public void touchDown(final float x, final float y){
    ...
    public void touchUp(final float x, final float y){

    }

    public int getMeasureSpecWith(int widthMeasureSpec){
        int width = 200;
    ...
    public int getMeasureSpecHeight(int heightMeasureSpec){
