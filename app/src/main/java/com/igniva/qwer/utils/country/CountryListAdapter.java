...
public class CountryListAdapter extends BaseAdapter {
  ...
  List<CountriesPojo> countries;
  LayoutInflater inflater;

  public CountryListAdapter(Context context, List<CountriesPojo> countries) {
    super();
  ...
  public View getView(int position, View view, ViewGroup parent) {
    CountriesPojo country = countries.get(position);

    if (view == null)
      view = inflater.inflate(R.layout.row, null);

    Cell cell = Cell.from(view);
    cell.textView.setText(country.getCountry());

    Glide.with(mContext).load(country.getCountry_flag()).into(cell.imageView);
